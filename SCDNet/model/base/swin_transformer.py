...
#     k = torch.load('/home/heyj/DCAMA/logs/train/fold_0_1210_024816/best_model.pt')
#     model = DCAMA('resnet50', '/home/heyj/DCAMA/backbones/resnet50_a1h-35c100f8.pth', False)
#     model.load_state_dict(k)
#     print(k.keys())
#     # print(k['module.backbone.layers.0.blocks.0.norm1.weight'])
#     assert 1==0
