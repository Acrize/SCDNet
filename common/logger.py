...
class Logger:
    ...
    def initialize(cls, args, training):
        ...
        logpath = os.path.join(args.logpath, 'train/fold_' + str(args.benchmark)  + str(args.fold) +'_'+ str(args.backbone) + logtime) if training \
    ...
    @classmethod
    def save_last_model(cls, model, epoch, val_miou):
